...
select и context в этом задании применять не надо. Костыли в виде time.Sleep - тоже
...
Это сложная домашка, наверное самая сложная на курсе. 

Тему с асинхроном спрашивают на всех собесах, так что не смотря на то что домашка сложная - крайне рекомендуется ее все же сделать самостоянельно без списываний.