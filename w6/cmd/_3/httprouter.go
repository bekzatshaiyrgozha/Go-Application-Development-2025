...
/*
curl -v -X PUT -H "Content-Type: application/json" -d '{"login":"student1"}' http://localhost:8080/users
*/
...
/*
curl -v -X POST -H "Content-Type: application/json" -d '{"name":"Almas Amanov"}' http://localhost:8080/users/rvasily
*/
