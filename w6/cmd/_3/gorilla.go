...
/*
curl -v -X PUT -H "Content-Type: application/json" -d '{"login":"student01"}' http://localhost:8080/users
*/
...
/*
curl -v -X POST -H "Content-Type: application/json"  -H "X-Auth: test" -d '{"name":"Almas Amanov"}' http://localhost:8080/users/rvasily
*/
